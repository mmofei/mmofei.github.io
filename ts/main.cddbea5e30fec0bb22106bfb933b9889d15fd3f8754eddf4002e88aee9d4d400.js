(() => {
  ...
  // ns-hugo-imp:D:\hugo\mofei\assets\ts\colorScheme.ts
  var require_colorScheme = __commonJS({
    "ns-hugo-imp:D:\\hugo\\mofei\\assets\\ts\\colorScheme.ts"() {
    }
  });

  // ns-hugo-imp:D:\hugo\mofei\themes\hugo-theme-stack\assets\ts\gallery.ts
  ...
  // ns-hugo-imp:D:\hugo\mofei\themes\hugo-theme-stack\assets\ts\color.ts
  var colorsCache = {};
  ...
  // ns-hugo-imp:D:\hugo\mofei\themes\hugo-theme-stack\assets\ts\menu.ts
  ...
  // ns-hugo-imp:D:\hugo\mofei\themes\hugo-theme-stack\assets\ts\createElement.ts
  ...
  // <stdin>
  var import_colorScheme = __toESM(require_colorScheme());

  // ns-hugo-imp:D:\hugo\mofei\themes\hugo-theme-stack\assets\ts\scrollspy.ts
  ...
  // ns-hugo-imp:D:\hugo\mofei\themes\hugo-theme-stack\assets\ts\smoothAnchors.ts
  ...
  var Stack = {
    init: () => {
      ...
      new import_colorScheme.default(document.getElementById("dark-mode-toggle"));
    }
  };
